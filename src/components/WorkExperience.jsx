...
const WorkExperience = () => {
  ...
  return (
    <section id="work-experience" className="min-h-screen bg-black text-white py-12 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-6 mb-8">
          ...
          <div className="flex-1 pr-4">
            ...
            <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700 mb-5 max-w-2xl">
