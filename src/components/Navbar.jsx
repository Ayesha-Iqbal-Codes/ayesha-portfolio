...
import {
  FaHome, FaUser, FaCode, FaProjectDiagram, FaChartLine,
  FaBriefcase, FaSchool, FaEnvelope, FaChevronLeft, FaChevronRight
} from 'react-icons/fa';
        ...
        <ul className="flex flex-col space-y-1 items-center">
          {Object.keys(iconMap).map((section) => (
            ...
            >
              ...
              {hoveredLink === section && (
                <span
                  className="hidden md:inline-block absolute right-[3.5rem] top-1/2 transform -translate-y-1/2 text-xs bg-purple-900 text-white py-1 px-2 rounded-lg whitespace-nowrap transition-opacity duration-300"
                  style={{
